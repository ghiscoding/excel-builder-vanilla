...
* **workbook:** add support for Excel Custom Functions ([fbebee4](https://github.com/ghiscoding/excel-builder-vanilla/commit/fbebee430a9fa825b91aa7592c457642d72992d4)) - by @ghiscoding
...
> [!NOTE]
> Please visit the [v5.0.0](https://github.com/ghiscoding/excel-builder-vanilla/releases/tag/v5.0.0) release for more details about the migration.
